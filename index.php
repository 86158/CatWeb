...
header("Content-Security-Policy-Report-Only: report-uri php/report.php; default-src 'none'; connect-src 'self'; script-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net/npm/ https://code.jquery.com; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net/npm/; font-src 'self' https://cdn.jsdelivr.net/npm/; img-src 'self' https: data:; media-src https://youtu.be/;"); // frame-src 'none'; manifest-src 'none'; object-src 'none'
